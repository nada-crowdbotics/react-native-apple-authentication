...
export default class AppleAuthModule {
  constructor() {
    if (RNAppleAuthModule) {
      this.emitter = new NativeEventEmitter(RNAppleAuthModule);
    }
  }
   ...
   */
  get isSupported() {
    return RNAppleAuthModule ? RNAppleAuthModule.isSupported : false;
  }
  ...
  get isSignUpButtonSupported() {
    return RNAppleAuthModule ? RNAppleAuthModule.isSignUpButtonSupported : false;
  }

  getCredentialStateForUser(user) {
    throwIfNotSupported(RNAppleAuthModule.isSupported);
    ...
    return RNAppleAuthModule.getCredentialStateForUser(user);
  }
  ...
  performRequest(
    ...
    return RNAppleAuthModule.performRequest(requestOptions);
  }
